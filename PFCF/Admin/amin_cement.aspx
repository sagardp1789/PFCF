<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin_master.Master" AutoEventWireup="true" CodeBehind="amin_cement.aspx.cs" Inherits="PFCF.Admin.amin_cement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
          ...
          <div class='row' id='content-wrapper'>
            <div class='col-xs-12'>
              ...
              <div class='alert alert-info alert-dismissable'>
                ...
                <strong>Cement Suppliers On ProHome</strong>
                ...
                <div class='col-sm-12'>
                  <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                    <div class='box-header orange-background'>
                      <div class='title'>Cement Suppliers</div>
                      <div class='actions'>
     ...
     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBCON %>" SelectCommand="SELECT * FROM [builderr] WHERE ([Business] = @Business)">
         <SelectParameters>
             <asp:Parameter DefaultValue="cement" Name="Business" Type="String" />
         </SelectParameters>
     </asp:SqlDataSource>
