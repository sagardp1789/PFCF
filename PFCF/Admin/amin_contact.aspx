<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin_master.Master" AutoEventWireup="true" CodeBehind="amin_contact.aspx.cs" Inherits="PFCF.Admin.amin_contact" %>
          ...
          <div class='row' id='content-wrapper'>
            <div class='col-xs-12'>
              ...
              <div class='alert alert-info alert-dismissable'>
                ...
                <strong>Contact Mails from ProHome users</strong>
              </div>
                <div class='row'>
                <div class='col-sm-12'>
                  <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                    <div class='box-header orange-background'>
                      <div class='title'>User contact</div>
                      <div class='actions'>
