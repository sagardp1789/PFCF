<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin_master.Master" AutoEventWireup="true" CodeBehind="amin_empuser.aspx.cs" Inherits="PFCF.Admin.amin_empuser" %>
          ...
          <div class='row' id='content-wrapper'>
            <div class='col-xs-12'>
              ...
              <div class='alert alert-info alert-dismissable'>
                ...
                <strong>Registered employees On ProHome</strong>
              </div>
                <div class='row'>
                <div class='col-sm-12'>
                  <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                    <div class='box-header orange-background'>
                      <div class='title'>All employees</div>
                      <div class='actions'>
