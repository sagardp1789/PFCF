<%@ Page Title="" Language="C#" MasterPageFile="~/Mainmaster.Master" AutoEventWireup="true" CodeBehind="buildregister.aspx.cs" Inherits="PFCF.WebForm1" %>
    ...
    <section id="header-page" class="header-margin-base">
			<div class="skyline">
				...
				<div class="container header-text">
					...
					<div><h2 class="sub-title">Builders Registeration</h2></div>
				</div>
			</div>
			<div id="breadcrumb">
				<div class="container">
					<ol class="breadcrumb">
						...
						<li class="active">Builders Register</li>
					</ol>
				</div>
			</div><!-- /#breadcrumb -->
			<span class="cover"></span>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-9 col-md-6">
						...
						<ul class="profile create">
                            <li>
                                <span>&nbsp Business</span><asp:TextBox ID="bus" runat="server" Text="Builder" Enabled="False"></asp:TextBox>
                            </li>
							<li>
								<span ><asp:RequiredFieldValidator ID="agnamev" runat="server" ForeColor="Red" ControlToValidate="agname" ErrorMessage="*"></asp:RequiredFieldValidator>Agency Name</span>
                                
                                <asp:TextBox ID="agname" placeholder="Enter Your Agency Name" class="form-control" runat="server"></asp:TextBox>
							</li>
							<li>
								<span><asp:RequiredFieldValidator ID="descriptionv" runat="server" ForeColor="Red" ControlToValidate="description" ErrorMessage="*"></asp:RequiredFieldValidator> Description</span> 
						...
						<ul class="profile create">
                            ...
                            <li>
								<span><asp:RequiredFieldValidator ID="imgv" runat="server" ForeColor="Red" ControlToValidate="imgup" ErrorMessage="*"></asp:RequiredFieldValidator> Upload Image </span>
						...
						<ul class="profile create">
							...
							<li>
								<span><asp:RequiredFieldValidator ID="passwordv" runat="server" ForeColor="Red" ControlToValidate="password" ErrorMessage="*"></asp:RequiredFieldValidator> Password</span>
                            <asp:TextBox ID="password" placeholder="Enter password" class="form-control" TextMode="Password" runat="server"></asp:TextBox>
					...
					<div class="col-sm-12 col-md-4">
						...
						<div class="section-title line-style">
							...
							<ul class="profile create">
								<li>
									<span><asp:RequiredFieldValidator ID="servicesv" runat="server" ForeColor="Red" ControlToValidate="service" ErrorMessage="*"></asp:RequiredFieldValidator>Services</span>
								    <asp:TextBox ID="service" class="form-control" placeholder="Eg: Commercial Buildings, Shopping Malls, etc." TextMode="MultiLine" runat="server"></asp:TextBox>
								</li>
							</ul>
				...
				<div class="row">
					<div class="col-sm-12 col-md-8 text-right">
                                        ...
                                        <asp:Button class="btn btn-default signin-button" ID="Button1" runat="server" Text="Create Agency" OnClick="Button1_Click" />
					<ul  class="profile create">
                        ...
                        <li><asp:CompareValidator ID="cpassv" runat="server" ControlToValidate="cpassword" ForeColor="Red" ControlToCompare="password" ErrorMessage="Password does not match"></asp:CompareValidator></li>
                        <li><asp:RegularExpressionValidator ID="pinv1" ValidationExpression="^([1-9])([0-9]){5}$" ForeColor="Red" ControlToValidate="pin" runat="server" ErrorMessage="Invalid pin code"></asp:RegularExpressionValidator></li>
                         </ul>
                    </div>
