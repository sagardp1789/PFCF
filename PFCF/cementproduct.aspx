<%@ Page Title="" Language="C#" MasterPageFile="~/Mainmaster.Master" AutoEventWireup="true" CodeBehind="cementproduct.aspx.cs" Inherits="PFCF.cementproduct" %>
...
<section id="recent-list">
			...
			<div class="container">
                ...
                <div class="list-box-title">
					<span><i class="icon fa fa-plus-square"></i><b>Cement Supplier</b></span>
				</div>
				<div class="row">
				<asp:Repeater ID="Repeater1" runat="server" >
                    ...
                    <div class="col-md-4">
						<div class="box-ads box-home">
							...
							<div class="address"><b>Cement</b><asp:Label ID="lblservices" runat="server" Text='<%# Eval("Service") %>'></asp:Label></div>
