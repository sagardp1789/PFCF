<%@ Page Title="" Language="C#" MasterPageFile="~/Mainmaster.Master" AutoEventWireup="true" CodeBehind="seller-reg.aspx.cs" Inherits="PFCF.seller_reg" %>
    ...
    <section id="header-page" class="header-margin-base">
			<div class="skyline">
				...
				<div class="container header-text">
					...
					<div><h2 class="sub-title">Cement Supplier Registeration</h2></div>
				</div>
			</div>
			<div id="breadcrumb">
				<div class="container">
					<ol class="breadcrumb">
						...
						<li class="active">Cement Supplier Register</li>
					</ol>
				</div>
			</div><!-- /#breadcrumb -->
			<span class="cover"></span>
				...
				<div class="row">
					...
					<div class="col-sm-9 col-md-6">
						...
						<ul class="profile create">
                            ...
                            <asp:TextBox ID="password" textmode="Password" placeholder="Enter password" class="form-control" runat="server"></asp:TextBox>
                            
							</li>
            
							<li>
								<span><asp:RequiredFieldValidator ID="cpasswordv" runat="server" ForeColor="Red" ControlToValidate="cpassword" ErrorMessage="*"></asp:RequiredFieldValidator>Cofirm Password</span>
                                <asp:TextBox  ID="cpassword" textmode="Password"  placeholder="Re-Enter Password" class="form-control" runat="server"></asp:TextBox>
					...
					<div class="col-sm-12 col-md-4">
						...
						<ul class="profile create">
							<li>
								<span><asp:RequiredFieldValidator ID="address1v" runat="server" ForeColor="Red" ControlToValidate="address1" ErrorMessage="*"></asp:RequiredFieldValidator> Address Line 1</span> 
						...
						<div class="section-title line-style">
							...
							<ul class="profile create">
								<li>
									<span><asp:RequiredFieldValidator ID="skillv" runat="server" ForeColor="Red" ControlToValidate="service" ErrorMessage="*"></asp:RequiredFieldValidator>Cement Company </span>
								
                                    <asp:TextBox ID="service" class="form-control" TextMode="MultiLine" placeholder="Eg: Ambuja, Birla, Penna, JK Super Cement, etc." runat="server"></asp:TextBox>
								</li>
							</ul>
